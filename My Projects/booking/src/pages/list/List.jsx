      ...
      <div className="listWrapper">
        <div className="listSearch">
          ...
          <div className="lsItem">
            ...
            <span onClick={()=>setOpenDate(!openDate)}>{`${format(date[0].startDate, 
            "dd/MM/yyyy")} to
            ${format(date[0].endDate, "dd/MM/yyy")}`}</span>
            {openDate && (
            <DateRange onClick={item=>setDate([item.selection])} 
            minDate={new Date()}
            ranges={date}/>)}
            </div>
            <div className="lsItem">
              ...
              <div className="lsOptionItem">
                <span className="lsOptionText">Chldren</span>
